...
const SCREENS = [
  { to: '/demo/defender', label: 'Defender Screen', sub: 'Main projector view', icon: Shield, accent: '#10B981' },
  { to: '/demo/attacker', label: 'Attacker Terminal', sub: "Judge's tablet", icon: Swords, accent: '#EF4444' },
  { to: '/demo/evidence', label: 'Evidence Feed', sub: 'Raw data & telemetry', icon: BarChart3, accent: '#8B5CF6' },
];
